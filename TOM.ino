#include "esp32notifications.h" //THE REAL DEAL 

#define D12 12 //D12 on the board
...
BLENotifications notifications; // Create an interface to the BLE notification library
